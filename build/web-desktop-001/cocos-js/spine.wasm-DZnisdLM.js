    ...
    execute: (function () {
      ...
      var spineWasm = exports("default", (() => {
        ...
        return function (spineWasm) {
          ...
          function xa(a) {
            return y || "function" != typeof fetch ? Promise.resolve().then(() => wa(a)) : fetch(a, {
          ...
          function M(a, b, c) {
            ...
            var g = Array(b.length),
              ...
              h = 0;
            b.forEach((f, l) => {
              I.hasOwnProperty(f) ? g[l] = I[f] : (k.push(f), H.hasOwnProperty(f) || (H[f] = []), H[f].push(() => {
                g[l] = I[f];
                ++h;
                h === k.length && d(g);
              }));
          ...
          function N(a, b) {
            ...
            I[a] = b;
            delete Da[a];
            H.hasOwnProperty(a) && (b = H[a], delete H[a], b.forEach(g => g()));
          }
          function Ja(a) {
          ...
          var vb = {
            ...
            c: function (a, b, c, d, g, k, h, f, l, n, m, q, p) {
              m = G(m);
              k = V(g, k);
              f && (f = V(h, f));
              n && (n = V(l, n));
            ...
            f: function (a, b, c, d, g, k, h) {
              ...
              M([], [a], function (l) {
                ...
                M([], f, function (p) {
                  ...
                  if (l.G.X) for (const u of l.G.X) u.constructor.hasOwnProperty(b) || (u.constructor[b] = p);
                  return [];
                });
                return [];
              });
            },
            h: function (a, b, c, d, g, k, h, f) {
              b = G(b);
              k = V(g, k);
              M([], [a], function (l) {
                l = l[0];
            ...
            b: function (a, b, c, d, g, k, h, f, l, n) {
              b = G(b);
              g = V(d, g);
              M([], [a], function (m) {
                m = m[0];
                ...
                Object.defineProperty(m.G.P, b, p);
                M([], l ? [c, h] : [c], function (u) {
                  ...
                  Object.defineProperty(m.G.P, b, v);
                  return [];
                });
                return [];
              });
...
//# sourceMappingURL=spine.wasm-DZnisdLM.js.map
